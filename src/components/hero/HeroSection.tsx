    ...
    <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 flex flex-col lg:flex-row items-center gap-12">
      <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
          <button className="cursor-pointer btn-brand px-7 py-3 rounded-lg font-semibold text-white border border-transparent hover:border-pink-500 hover:text-pink-500 transition-all duration-300 shadow-lg">
